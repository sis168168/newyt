...
set JAVA_OPTS=-Dfile.encoding=GBK -Xmx512M -Xms64M -Xss1M -XX:MaxPermSize=256M -XX:+UseParallelGC %PLAY_OPTS%
...
"%_JAVACMD%" %_JAVA_OPTS% %_PROPS% -cp "%_TOOL_CLASSPATH%" com.xjl.server.XjlServer %*
goto end
